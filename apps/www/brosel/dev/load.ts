...
export const loadAssets = async () => {
	...
	// Add Css file to assets object, to render the styles
	// on the different pages in the browser
	assetsObject[`${assetsPath}/styles.css`] = () => {
		return new Response(Bun.file(`${process.cwd()}/${config.devDir}/out.css`));
	};
